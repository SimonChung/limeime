...
enum IMCatalog {
    ...
    static let families: [IMFamily] = [
        ...
        .init(
            ...
            variants: [
                .init(id: "dayi",     name: "標準",     filename: "dayi.zip",     tableName: "dayi", imName: "dayi",  label: "大易",     keyboardId: "dayi", recordCount: 18_638,  compressedKB: 486, isLimeDB: false),
                .init(id: "dayiuni",  name: "統一碼",   filename: "dayiuni.zip",  tableName: "dayi", imName: "dayi",  label: "大易",     keyboardId: "dayi", recordCount: 27_198,  compressedKB: 584, isLimeDB: false),
                .init(id: "dayiunip", name: "統一碼全", filename: "dayiunip.zip", tableName: "dayi", imName: "dayi",  label: "大易",     keyboardId: "dayi", recordCount: 117_766, compressedKB: 2700, isLimeDB: false),
            ]
        ),
        .init(
            id: "ez",
