...
- Any documented screenshot is missing from `/manual/`.
...
- `manual/keyboard-input.md` is text-only or lacks representative Chinese, English, and Emoji keyboard screenshots.
...
Before completion, enumerate screenshot paths from `docs/LIME_SETTINGS.md` and `docs/KEYBOARD_THEME.md`, then verify every path appears in `manual/**/*.md`.
