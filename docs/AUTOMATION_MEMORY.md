...
Last updated: 2026-05-21T16:41:27+08:00 (Asia/Taipei)
...
- #70: Community request to hide or configure next-code/next-character candidates. Reporter clarified it is not a physical keyboard issue and provided screenshots comparing LimeIME and Trime in comment `4502590614`; latest follow-up in comment `4506343665` clarifies the requested setting is the number of `延伸編碼` candidates, where `0` would mean disabled. Keep open as `enhancement` + `Usability`; next action is product/author-team evaluation.
...
- Time: 2026-05-21T16:41:27+08:00
- From: Hermes GitHub webhook `issue_comment.created`
- Summary: Reporter `ejmoog` added #70 clarification after maintainer `jrywu` asked what `顯示0到9個「下一順位字」` means. Latest comment `4506343665` says the request is to configure the number of `延伸編碼` candidates, with `0` meaning disabled. Hermes updated this mutable state; no public reply was posted because this is product/author-team evaluation context and prior acknowledgement already covers the enhancement.
- Needs: Debug #63 further; implement/fix #71 and #75. Product/author-team decisions remain for #70/#72/#73/#74; for #70 specifically, decide whether Android should expose an option to limit/disable next-code/extension-code candidates. Watch #58 for sample-table follow-up.
- Links: #70 latest comment `https://github.com/lime-ime/limeime/issues/70#issuecomment-4506343665`; #63 `https://github.com/lime-ime/limeime/issues/63`; #75 latest comment `https://github.com/lime-ime/limeime/issues/75#issuecomment-4506232521`; current APK raw URL `https://raw.githubusercontent.com/lime-ime/limeime/master/LimeStudio/app/release/LIMEHD2026-6.1.7.apk`; #74 `https://github.com/lime-ime/limeime/issues/74`; #73 `https://github.com/lime-ime/limeime/issues/73`; #58 latest answer `https://github.com/lime-ime/limeime/issues/58#issuecomment-4504038716`; #71 latest acknowledgement `https://github.com/lime-ime/limeime/issues/71#issuecomment-4504791937`.
