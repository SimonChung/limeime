...
- Needs: Watch #58 only for reporter follow-up or a failing sample table. Continue watching #70 for reporter confirmation after the suggested-candidate display-count option; debug #63; implement/fix #71 and #75; product/author-team decisions remain for #72/#73; #74 product scope is narrowed to URL/URI fields only, with email/number/date-time/phone/password remaining inputType-specific.
