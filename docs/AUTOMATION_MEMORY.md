...
Last updated: 2026-05-21T20:09:10+08:00 (Asia/Taipei)
...
- Time: 2026-05-21T20:09:10+08:00
- From: Hermes GitHub webhook `issue_comment.created`
- Summary: Automation/`limeimetw` added a #74 supplemental product-direction comment narrowing the current `記憶中英模式` enhancement evaluation to URL/URI fields; email, number/date-time, phone, and password fields remain Android-inputType-driven for now. Hermes verified live #74 comments and updated this mutable state; no further public reply is needed.
- Needs: Continue watching #70 for reporter confirmation after the suggested-candidate display-count option; watch #58 only for reporter follow-up or a failing sample table; debug #63; implement/fix #71 and #75; product/author-team decisions remain for #72/#73; #74 product scope is narrowed to URL/URI fields only.
- Links: #74 supplemental comment `https://github.com/lime-ime/limeime/issues/74#issuecomment-4508117965`; #74 maintainer comment `https://github.com/lime-ime/limeime/issues/74#issuecomment-4505846029`; #58 maintainer comment `https://github.com/lime-ime/limeime/issues/58#issuecomment-4506696064`; #70 maintainer comment `https://github.com/lime-ime/limeime/issues/70#issuecomment-4506632626`; #63 `https://github.com/lime-ime/limeime/issues/63`; #75 latest comment `https://github.com/lime-ime/limeime/issues/75#issuecomment-4506232521`; current APK raw URL `https://raw.githubusercontent.com/lime-ime/limeime/master/LimeStudio/app/release/LIMEHD2026-6.1.7.apk`; #73 `https://github.com/lime-ime/limeime/issues/73`; #71 latest acknowledgement `https://github.com/lime-ime/limeime/issues/71#issuecomment-4504791937`.
