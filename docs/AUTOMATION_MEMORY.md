...
Last updated: 2026-05-21T15:45:16+08:00 (Asia/Taipei)
...
- #74: Community question/enhancement about Android `記憶中英模式` and inputType-driven switching. Maintainer `jrywu` explained in comment `4505846029` that URL/email fields use English-related keyboards, number uses phone keyboard, and `記憶中英模式` only remembers English/Chinese for normal text fields. Keep open as product/author-team evaluation for whether an optional fixed-Chinese-start override should be added; no additional public reply needed unless maintainer wants follow-up.
